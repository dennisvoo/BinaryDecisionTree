...
public class BSTreeTester_EC {
  private BSTree_EC<String> stringTree;
  private BSTree_EC<Integer> numTree;
  private BSTree_EC<String> myTree; // used for testing In Order Traversal
  ...
  @Before
  public void setUp() {
    stringTree = new BSTree_EC<String>();
    stringTree.insert("Dennis", "Vo");
    
    numTree = new BSTree_EC<Integer>();
    numTree.insert(1234, 4321);
    
    myTree = new BSTree_EC<String>();
  }
  ...
  public void testSize() {
    ...
    assertEquals(0, stringTree.findHeight(1));
    assertEquals(1, numTree.findHeight(1));
    assertEquals(1, numTree.findHeight(2));
  }
  ...
  public void testLoad() {
    ...
    myTree.loadData("sample.txt");
    System.out.println("testing the load");
  ...
  public void testPrint() {
    ...
    assertEquals(5,myTree.findHeight(1));
    assertEquals(4,myTree.findHeight(2));
    assertEquals(2,myTree.leafCount(1));
    assertEquals(3,myTree.leafCount(2));
    assertEquals(2,myTree.levelCount(2,1));
    assertEquals(3,myTree.levelCount(3,2));
    myTree.saveData("hi.txt");
  }
}
